    ...
    >
      ...
      >
        ...
        <div>
          ...
          <p className="mt-[8px] font-normal sm:text-[18px] text-[12px] sm:leading-8 leading-6 text-white">
            Founder | Metaversus
          </p>
        </div>
        <p className="mt-[24px] font-normal sm:text-[24px] text-[18px] sm:leading-32 leading-10 text-white">
